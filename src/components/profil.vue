	...
	<div class=" w-[100%] h-[1024px] flex justify-center items-center">
		...
		<div
			...
			<div id="form-outer" class="font py-[50px] w-[50%]">
				<div
					class="bg-white border-[2px] border-[#4E5166] mb-[30px] p-[5px] rounded-[10px] flex justify-center">
					<h1 id="title" class="text-3xl">Profil</h1>
				...
				<form id="survey-form" @submit.prevent="handleSubmit" class="flex flex-col gap-[20px]">
					<div class="bg-white border-[2px] border-[#4E5166] p-[20px] rounded-[10px]">
						<div class="rowTab">
							...
							<div class="rightTab">
								<input autofocus type="text" name="surname" id="surname" v-model="surname"
									class="input-field w-[100%] py-[8px] rounded-[15px] border-[1px] border-[#4E5166] shadow-md focus:shadow-[#DE5F5F] outline-none shadow-[1px] focus:border-[#DE5F5F] focus:border-[1px] px-[10px] font-normal bg-[#FFF0F0]"
						...
						<div class="rowTab">
							...
							<div class="rightTab">
								<input autofocus type="text" name="name" id="name" v-model="name"
									class="input-field w-[100%] py-[8px] rounded-[15px] border-[1px] border-[#4E5166] shadow-md focus:shadow-[#DE5F5F] outline-none shadow-[1px] focus:border-[#DE5F5F] focus:border-[1px] px-[10px] font-normal bg-[#FFF0F0]"
						...
						<div class="rowTab">
							...
							<div class="rightTab">
								<input type="email" name="email" id="email" v-model="email"
									class="input-field w-[100%] py-[8px] rounded-[15px] border-[1px] border-[#4E5166] shadow-md focus:shadow-[#DE5F5F] outline-none shadow-[1px] focus:border-[#DE5F5F] focus:border-[1px] px-[10px] font-normal bg-[#FFF0F0]"
									required placeholder="Ton Email">
							</div>
						</div>
						<div class="rowTab">
							<div class="labels"><!-- demande de nom -->
							...
							<div class="rightTab">
								<input autofocus type="text" name="job" id="job" v-model="job"
									class="input-field w-[100%] py-[8px] rounded-[15px] border-[1px] border-[#4E5166] shadow-md focus:shadow-[#DE5F5F] outline-none shadow-[1px] focus:border-[#DE5F5F] focus:border-[1px] px-[10px] font-normal bg-[#FFF0F0] "
									placeholder="Ta profession" required>
							</div>
						</div>
						<div class="rowTab">
							...
							<div class="rightTab">
								<input type="number" name="age" id="number" v-model="age" min="18" max="80"
									class="input-field w-[100%] py-[8px] rounded-[15px] border-[1px] border-[#4E5166] shadow-md focus:shadow-[#DE5F5F] outline-none shadow-[1px] focus:border-[#DE5F5F] focus:border-[1px] px-[10px] font-normal bg-[#FFF0F0]"
									required placeholder="Ton âge">
							</div>
						</div>
						<div class="rowTab">
							...
							<div class="rigtTab">
								<textarea id="comments" v-model="comments"
									class="input-field w-[100%] py-[8px] rounded-[15px] border-[1px] border-[#4E5166] shadow-md focus:shadow-[#DE5F5F] outline-none shadow-[1px] focus:border-[#DE5F5F] focus:border-[1px] max-h-[200px] px-[10px] font-normal bg-[#FFF0F0]"
									style="height:50px; resize:vertical;"
									placeholder="Ecrivez quelques mots sur vous-même..."></textarea>
							</div>
						</div>
					</div>
					<div>
						<button id="submit" type="submit"
							class="bg-gradient-to-b from-[#FFD7D7] to-[#FF8787] py-[10px] px-[40px] rounded-[20px] border-[2px] border-white text-white tracking-[1px] uppercase cursor-pointer transition transform duration-[0.1s] ease-in active:transform active:scale-[0.9]">Envoi
							!</button>
					</div>
				</form>
			</div>
